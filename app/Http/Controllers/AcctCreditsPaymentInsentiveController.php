            ...
            $incentive = $val->incentive / 100 * $totalbunga;
              ...
              $export .= "<tr>
                          ...
                          <tr>
                            ...
                            <td style=\"border-top: 1px solid black\"><div style=\"font-size:10;text-align:right\">".number_format($totalbunga, 2)."</div></td>
                          </tr>
                          <tr>
                              <td colspan=\"3\"><div style=\"font-size:10;text-align:left;font-style:italic\">Insentif : ".$val->incentive." % x ".number_format($totalbunga, 2)." = Rp.".number_format($incentive)."</div></td>
