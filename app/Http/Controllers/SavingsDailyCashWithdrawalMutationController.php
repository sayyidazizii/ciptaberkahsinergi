...
class SavingsDailyCashWithdrawalMutationController extends Controller
{
    public function index()
    {
        ...
        return view('content.SavingsDailyCashMutation.addCashWithdrawal.index', compact('corebranch'));
    }
    ...
    public function processPrinting($sesi){
        ...
        <table cellspacing=\"0\" cellpadding=\"1\" border=\"0\" width=\"100%\">
            ...
            <tr>
                <td><div style=\"text-align: left;font-size:12;font-weight:bold\">MUTASI SIMPANAN PENARIKAN TUNAI TGL : &nbsp;&nbsp; ".$sesi['start_date']."&nbsp;&nbsp; S.D &nbsp;&nbsp;".$sesi['end_date']."</div></td>		
            </tr>					
        </table>";
    ...
    public function export($sesi){
        ...
        if(count($acctsavingcashmutation)>=0){
            ...
            ->setTitle("Laporan Mutasi Harian Penarikan Tunai Simpanan")
            ->setSubject("")
            ->setDescription("Laporan Mutasi Harian Penarikan Tunai Simpanan")
            ->setKeywords("Laporan, Mutasi, Harian, Penarikan, Tunai, Simpanan")
            ->setCategory("Laporan Mutasi Harian Penarikan Tunai Simpanan");
            ...
            $sheet->setCellValue('B1', "Laporan Mutasi Harian Penarikan Tunai Simpanan ".date('d M Y'));	
            ...
            ob_clean();
            $filename='Laporan Mutasi Harian Penarikan Tunai Simpanan.xls';
