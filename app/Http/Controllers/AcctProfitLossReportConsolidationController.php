...
class AcctProfitLossReportConsolidationController extends Controller
{
    public function index()
    {
        ...
        return view('content.AcctProfitLossReportConsolidation.List.index', compact('monthlist', 'year', 'corebranch', 'profitlossreporttype', 'sessiondata', 'company_name', 'acctprofitlossreport_top', 'acctprofitlossreport_bottom', 'account_income_tax_id'));
    }
    ...
    public function filter(Request $request){
        ...
        return redirect('profit-loss-report-consolidation');
    }
    ...
    public function processPrinting(){
        ...
        <table cellspacing=\"0\" cellpadding=\"1\" border=\"0\" width=\"100%\">
            <tr>
                <td><div style=\"text-align: center;font-size:10; font-weight:bold;\">LAPORAN LABA RUGI KONSOLIDASI</div></td>
            </tr>
            <tr>
                <td><div style=\"text-align: center;font-size:10; font-weight:bold;\">".$preferencecompany['company_name']."</div></td>
            </tr>
            <tr>
                <td><div style=\"text-align: center;font-size:10;\"></div></td>
            </tr>
            <tr>
    ...
    public function export(){
        ...
        if(count($acctprofitlossreport_top)>=0 && count($acctprofitlossreport_bottom)>=0 ){
            ...
            $spreadsheet->getActiveSheet()->setCellValue('B1',"LAPORAN LABA RUGI KONSOLIDASI");	
            ...
            ob_clean();
            $filename='Laporan Laba Rugi Konsolidasi.xls';
