        ...
        if(!empty($sesi['office_id'])){
            ...
            <table cellspacing=\"0\" cellpadding=\"1\" border=\"0\" width=\"100%\">
                <tr>
                    ...
                    <td width=\"10%\" style=\"border-bottom: 1px solid black;border-top: 1px solid black\"><div style=\"text-align: right;font-size:10;\">Tanggal Angsur</div></td>
                </tr>
            </table>
            <table cellspacing=\"0\" cellpadding=\"1\" border=\"0\" width=\"100%\">";
                ...
                if(!empty($acctcreditsaccount)){
                    ...
                    foreach ($acctcreditsaccount as $key => $val) {
                        ...
                        <tr>
                            ...
                            <td width=\"10%\"><div style=\"text-align: right;\">".date('d-m-Y',strtotime($val['credits_account_payment_date']))."</div></td>
                        </tr>";
