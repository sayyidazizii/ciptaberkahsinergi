...
class AcctCreditsAccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'content.AcctCreditsPaymentDebet.Add.AcctCreditsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctCreditsPaymentDebet/AcctCreditsAccountDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('payment-debet-modal-credits-account-table')
    ...
    {
        return 'AcctCreditsPaymentDebet/AcctCreditsAccount_' . date('YmdHis');
    }
}
