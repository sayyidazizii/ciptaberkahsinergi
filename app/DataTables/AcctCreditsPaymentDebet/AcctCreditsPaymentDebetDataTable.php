...
class AcctCreditsPaymentDebetDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'content.AcctCreditsPaymentDebet.List._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctCreditsPaymentDebet/AcctCreditsPaymentDebetDataTable $model
    ...
    public function query(AcctCreditsPayment $model)
    {
        ...
        ->where('acct_credits_payment.credits_payment_type', 1)
    ...
    {
        return $this->builder()
                    ->setTableId('credits-payment-debet-table')
