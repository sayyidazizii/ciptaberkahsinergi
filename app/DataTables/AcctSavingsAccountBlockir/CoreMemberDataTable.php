...
class CoreMemberDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctSavingsAccountBlockir.Add.CoreMemberModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctSavingsAccountBlockir/CoreMemberDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('acctsavingsaccountblockir-corememberdatatable-table')
    ...
    {
        return 'AcctSavingsAccountBlockir/CoreMember_' . date('YmdHis');
    }
}
