...
class AcctSavingsAccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctDepositoAccountClosing.Add.AcctSavingsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctDepositoAccountClosing/AcctSavingsAccountDataTable $model
    ...
    public function query(AcctSavingsAccount $model)
    {
        ...
        $acctdepositoaccount    = AcctDepositoAccount::withoutGlobalScopes()
