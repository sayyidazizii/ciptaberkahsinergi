...
class AcctCreditsPaymentBranchDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'content.AcctCreditsPaymentBranch.List._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctCreditsPaymentBranch/AcctCreditsPaymentBranchDataTable $model
    ...
    public function query(AcctCreditsPayment $model)
    {
        ...
        ->where('acct_credits_payment.credits_branch_status', 1)
    ...
    {
        return $this->builder()
                    ->setTableId('credits-payment-branch-table')
