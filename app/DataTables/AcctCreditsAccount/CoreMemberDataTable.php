...
class CoreMemberDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctCreditsAccount.Add.CoreMemberModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\CoreMember $model
    ...
    {
        return $this->builder()
                    ->setTableId('creditsaccount-corememberdatatable-table')
    ...
    {
        return 'CreditsAccount/CoreMember_' . date('YmdHis');
    }
}
