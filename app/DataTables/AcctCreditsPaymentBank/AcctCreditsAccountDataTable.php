...
class AcctCreditsAccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'content.AcctCreditsPaymentBank.Add.AcctCreditsAccountModal._action-menu');
    }
    ...
    {
        return $this->builder()
                    ->setTableId('payment-bank-modal-credits-account-table')
    ...
    {
        return 'AcctCreditsPaymentBank/AcctCreditsAccount_' . date('YmdHis');
    }
}
