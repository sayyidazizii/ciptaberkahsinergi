...
namespace App\DataTables\AcctCreditsPaymentBank;
...
class AcctCreditsPaymentBankDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'content.AcctCreditsPaymentBank.List._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctCreditsPaymentBank/AcctCreditsPaymentBankDataTable $model
    ...
    public function query(AcctCreditsPayment $model)
    {
        ...
        ->where('acct_credits_payment.bank_account_id', '!=', 0)
    ...
    {
        return $this->builder()
                    ->setTableId('credits-payment-bank-table')
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('acct_bank_account.bank_account_name')->title(__('Bank Transfer'))->data('bank_account_name'),
