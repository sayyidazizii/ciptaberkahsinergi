...
class SavingsAccountFromDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.SavingsTransferMutation.Add.SavingsAccountFromModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\SavingsTransferMutation/SavingsAccountFromDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('savingstransfermutation-savingsaccountfromdatatable-table')
    ...
    {
        return 'SavingsTransferMutation/SavingsAccountFrom_' . date('YmdHis');
    }
}
