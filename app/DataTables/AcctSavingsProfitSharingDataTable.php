...
class AcctSavingsProfitSharingDataTable extends DataTable
{
    ...
    {
        return [
            Column::make('acct_savings_profit_sharing_temp.savings_profit_sharing_temp_id')
                ->title(__('No'))
                ->data('DT_RowIndex'),
            Column::make('acct_savings_profit_sharing_temp.savings_profit_sharing_temp_period')
                ->title(__('Periode Bunga'))
                ->data('savings_profit_sharing_temp_period'),
            Column::make('acct_savings_account.savings_account_no')
                ->title(__('No. Rekening'))
                ->data('savings_account_no'),
            Column::make('core_member.member_name')
                ->title(__('Nama'))
                ->data('member_name'),
            Column::make('core_member.member_address')
                ->title(__('Alamat'))
                ->data('member_address'),
            Column::make('acct_savings_profit_sharing_temp.savings_account_last_balance')
                ->title(__('Saldo'))
                ->data('savings_account_last_balance'),
            Column::make('acct_savings_profit_sharing_temp.savings_tax_temp_amount')
                ->title(__('Pajak'))
                ->data('savings_tax_temp_amount'),
            Column::make('acct_savings_profit_sharing_temp.savings_profit_sharing_temp_amount')
                ->title(__('Bunga'))
                ->data('savings_profit_sharing_temp_amount'),
        ];
    }
