...
class SavingsAccountDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.MemberSavingsTransferMutation.Add.SavingsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\MemberSavingsTransferMutation/SavingsAccountDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('membersavingstransfermutation-savingsaccountdatatable-table')
    ...
    {
        return 'MemberSavingsTransferMutation/SavingsAccount_' . date('YmdHis');
    }
}
