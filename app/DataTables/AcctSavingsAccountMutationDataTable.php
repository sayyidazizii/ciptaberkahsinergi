...
class AcctSavingsAccountMutationDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctSavingsAccountMutation.AcctSavingsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\SavingsAccountMutation $model
    ...
    {
        return $this->builder()
                    ->setTableId('savingsaccountmutation-table')
    ...
    {
        return 'SavingsAccountMutation_' . date('YmdHis');
    }
}
