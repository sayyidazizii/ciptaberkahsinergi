...
class AcctSavingsAccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctSavingsCashMutation.Add.AcctSavingsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctSavingsCashMutation/AcctSavingsAccountDataTable $model
    ...
    public function query(AcctSavingsAccount $model)
    {
        ...
        ->withoutGlobalScopes()
        ->select('acct_savings_account.savings_account_id', 'acct_savings.savings_name','acct_savings_account.branch_id','acct_savings_account.savings_account_no', 'core_member.member_name', 'core_member.member_address')
    ...
    {
        return $this->builder()
                    ->setTableId('deposito-account-modal-savings-account-table')
