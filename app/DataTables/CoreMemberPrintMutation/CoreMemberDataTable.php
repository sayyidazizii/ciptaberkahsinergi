...
class CoreMemberDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.CoreMemberPrintMutation.CoreMemberModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\CoreMemberPrintMutation/CoreMemberDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('member-print-mutation-modal-member-table')
