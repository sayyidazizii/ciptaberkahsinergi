...
class AcctCreditsAccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', 'content.AcctCreditsPaymentCash.Add.AcctCreditsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctCreditsPaymentCash/AcctCreditsAccountDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('payment-cash-modal-credits-account-table')
    ...
    {
        return 'AcctCreditsPaymentCash/AcctCreditsAccount_' . date('YmdHis');
    }
}
