...
class AcctSavingsAccountMonitorDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctSavingsAccountMonitor.AcctSavingsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\SavingsAccountMonitorDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('savingsaccountmonitordatatable-table')
