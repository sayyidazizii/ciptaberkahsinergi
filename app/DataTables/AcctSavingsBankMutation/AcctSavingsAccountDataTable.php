...
class AcctSavingsAccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctSavingsBankMutation.Add.AcctSavingsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctSavingsBankMutation/AcctSavingsAccountDataTable $model
    ...
    {
        return 'AcctSavingsBankMutation/AcctSavingsAccount_' . date('YmdHis');
    }
}
