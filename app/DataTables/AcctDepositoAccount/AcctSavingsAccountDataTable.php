...
class AcctSavingsAccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctDepositoAccount.Add.AcctSavingsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctDepositoAccount/AcctSavingsAccountDataTable $model
    ...
    {
        return 'AcctDepositoAccount/AcctSavingsAccount_' . date('YmdHis');
    }
}
