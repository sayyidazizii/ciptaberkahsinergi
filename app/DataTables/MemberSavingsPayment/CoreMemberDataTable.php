...
class CoreMemberDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.MemberSavingsPayment.Edit.CoreMemberModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\MemberSavingsPayment/CoreMemberDataTable $model
    ...
    {
        return $this->builder()
                    ->setTableId('membersavingspayment-corememberdatatable-table')
    ...
    {
        return 'MemberSavingsPayment/CoreMember_' . date('YmdHis');
    }
}
