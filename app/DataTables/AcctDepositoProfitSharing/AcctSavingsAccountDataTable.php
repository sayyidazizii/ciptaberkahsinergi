...
class AcctSavingsAccountDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('action', 'content.AcctDepositoProfitSharing.Add.AcctSavingsAccountModal._action-menu');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\AcctDepositoProfitSharing/AcctSavingsAccountDataTable $model
    ...
    {
        return 'AcctDepositoProfitSharing/AcctSavingsAccount_' . date('YmdHis');
    }
}
