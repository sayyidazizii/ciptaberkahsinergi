@php
    ...
    $nav = array(
        ...
        array('title' => 'Details', 'view' => 'user/settings'),
        ...
        <div class="d-flex flex-wrap flex-sm-nowrap mb-3 align-items-center">
            ...
            <div class="me-7 mb-4">
                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                    <img src="{{ auth()->user()->avatar == '' ? auth()->user()->avatar_url : asset('storage/images/'.auth()->user()->avatar) }}" alt="image"/>
            ...
            <div class="flex-grow-1">
                ...
                <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                    ...
                    <div class="d-flex flex-column">
                        ...
                        <!--begin::Info-->
                        <div class="d-flex flex-warp fw-bold fs-6 mb-4 pe-2">
                            <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
                                {!! theme()->getSvgIcon("icons/duotune/communication/com006.svg", "svg-icon-4 me-1") !!}
                                {{ SettingsController::getUserGroupName(auth()->user()->user_group_id) }}
                            </a>
                            {{-- <a href="#" class="d-flex align-items-center text-gray-400 text-hover-primary me-5 mb-2">
