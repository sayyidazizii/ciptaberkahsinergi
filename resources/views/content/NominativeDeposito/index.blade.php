    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('Laporan Nominatif Simpanan Berjangka Anggota') }}</h3>
            </div>
        </div>

        <div id="kt_nominative_deposito_view">
            <form id="kt_nominative_deposito_view_form" class="form" method="POST" action="{{ route('nominative-deposito-report.viewport') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_nominative_deposito_submit" id="view" name="view" value="pdf">
