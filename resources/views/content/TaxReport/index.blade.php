    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('Laporan Pajak') }}</h3>
            </div>
        </div>

        <div id="kt_tax_report_view">
            <form id="kt_tax_report_view_form" class="form" method="POST" action="{{ route('tax-report.viewport') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <button type="submit" class="btn btn-primary" id="kt_tax_report_submit" id="view" name="view" value="pdf">
