...
<x-base-layout>
    <div class="card">
        ...
        <form id="kt_filter_savings_account_form" class="form" method="POST" action="{{ route('balance-sheet-consolidation.filter') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
                                                ...
                                                foreach ($acctbalancesheetreport_left as $key => $val) {
                                                    ...
                                                    ";
                                                        ...
                                                        if($val['report_type1']	== 3){
                                                            $last_balance1 	= BalanceSheetConsolidationController::getLastBalance($val['account_id1'], empty($session['branch_id']) ? auth()->user()->branch_id : $session['branch_id'], $last_month, $last_year);
                                            ...
                                            foreach ($acctbalancesheetreport_right as $key => $val) {
                                                ...
                                                ";
                                                    if($val['report_type2']	== 3){
                                                        ...
                                                        $last_balance2 	= BalanceSheetConsolidationController::getLastBalance($val['account_id2'], empty($session['branch_id']) ?  : $session['branch_id'], $last_month, $last_year);
                                                ...
                                                ";
                                                    if($val['report_type2']	== 7){
                                                        ...
                                                        $last_balance2 	= BalanceSheetConsolidationController::getAccountAmount($val['account_id2'],$month, $month, $last_year,empty($session['branch_id']) ? auth()->user()->branch_id : $session['branch_id'],2);
                                                ...
                                                // loop income
                                                    ...
                                                    if($val['report_type2'] == 8){
                                                        if(!empty($val['report_formula2']) && !empty($val['report_operator2'])){
                                                            ...
                                                            // $baris= count($report_formula2);
                                                            // $report = $report_operator2[];
                                                            $total_account_amount2_shu	= 0;
                                                            for($i = 0; $i < count($report_formula2); $i++){
                                                                if($report_operator2[$i] == '-'){
                                                                    if($total_account_amount2_shu == 0 ){
                                                                        $total_account_amount2_shu = $total_account_amount2_shu + $account_amount2_bottom_shu[$report_formula2[$i]];
                                                                    } else {
                                                                        $total_account_amount2_shu = $total_account_amount2_shu - $account_amount2_bottom_shu[$report_formula2[$i]];
                                                                    }
                                                                } else if($report_operator2[$i] == '+'){
                                                            ...
                                                            for($i = 0; $i < count($report_formula2); $i++){
                                                                if($report_operator2[$i] == '-'){
                                                                    if($total_account_amount_beban == 0 ){
                                                                        $total_account_amount_beban = $total_account_amount_beban + $account_amount2_bottom_shu[$report_formula2[$i]];
                                                                    } else {
                                                                        $total_account_amount_beban = $total_account_amount_beban - $account_amount2_bottom_shu[$report_formula2[$i]];
                                                                    }
                                                                } else if($report_operator2[$i] == '+'){
