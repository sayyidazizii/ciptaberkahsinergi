<x-base-layout>
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_savings_report_view">
            <form id="kt_savings_report_view_form" class="form" method="POST" action="{{ route('officer-savings-account-report.viewport') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_savings_report_submit" id="view" name="view" value="pdf">
