    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('Form Tambah Kode Bank') }}</h3>
            </div>
        ...
        <div id="kt_user_add_view">
            <form id="kt_bank_account_add_view_form" class="form" method="POST" action="{{ route('bank-account.process-add') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
                <div class="card-body border-top p-9">
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="bank_account_code" class="form-control form-control-lg form-control-solid" placeholder="Kode Bank" value="{{ old('bank_account_code', '' ?? '') }}" autocomplete="off"/>
                        </div>
                    </div>
                    <div class="row mb-6">
                        <label class="col-lg-4 col-form-label fw-bold fs-6 required">{{ __('Nama Bank') }}</label>
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="bank_account_name" class="form-control form-control-lg form-control-solid" placeholder="Nama Bank" value="{{ old('bank_account_name', '' ?? '') }}" autocomplete="off"/>
                        </div>
                    </div>
                    <div class="row mb-6">
                        <label class="col-lg-4 col-form-label fw-bold fs-6 required">{{ __('No. Rekening') }}</label>
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="bank_account_no" class="form-control form-control-lg form-control-solid" placeholder="No. Rekening" value="{{ old('bank_account_no', '' ?? '') }}" autocomplete="off"/>
                        </div>
                    </div>
                    <div class="row mb-6">
