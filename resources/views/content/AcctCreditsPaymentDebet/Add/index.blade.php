                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="savings_account_last_balance" class="form-control form-control-lg form-control-solid" placeholder="Saldo tabungan" value="{{ old('savings_account_no', $acctsavingsaccount['savings_account_last_balance'] ?? '') }}" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row mb-6">
