...
const form = document.getElementById('kt_deposito_account_closing_add_view_form');
...
const submitButton = document.getElementById('kt_deposito_account_closing_add_submit');
...
$(document).ready(function(){
    $('#open_modal_button').click(function(){
        $.ajax({
            type: "GET",
            url : "{{route('deposito-account-closing.modal-savings-account')}}",
    ...
    $("#deposito_account_amount_adm_view").change(function(){
        ...
        document.getElementById("deposito_account_amount_adm").value       = deposito_account_amount_adm;
        document.getElementById("deposito_account_amount_adm_view").value   = toRp(deposito_account_amount_adm);
...
function function_elements_add(name, value){
    $.ajax({
        type: "POST",
        url : "{{route('deposito-account-closing.elements-add')}}",
        data : {
            'name'      : name, 
            'value'     : value,
            '_token'    : '{{csrf_token()}}'
...
<x-base-layout>
    <div class="card">
        <div class="card-header">
            ...
            <a href="{{ route('deposito-account-closing.index') }}" class="btn btn-light align-self-center">
                {!! theme()->getSvgIcon("icons/duotune/arrows/arr079.svg", "svg-icon-4 me-1") !!}
                {{ __('Kembali') }}
            </a>
        </div>

        <div id="kt_deposito_account_closing_view">
            <form id="kt_deposito_account_closing_add_view_form" class="form" method="POST" action="{{ route('deposito-account-closing.process-update') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="deposito_account_interest_amount_view" id="deposito_account_interest_amount_view" class="form-control form-control-lg form-control-solid" placeholder="Rupiah" value="{{ old('deposito_account_interest_amount_view', number_format($acctdepositoaccount['deposito_account_interest_amount'], 2) ?? '') }}" autocomplete="off" readonly/>
                                    <input type="hidden" name="deposito_account_interest_amount" id="deposito_account_interest_amount" class="form-control form-control-lg form-control-solid" placeholder="Rupiah" value="{{ old('deposito_account_interest_amount', $acctdepositoaccount['deposito_account_interest_amount'] ?? '') }}" autocomplete="off"/>
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-bold fs-6">{{ __('Pajak') }}</label>
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="tax_total_view" id="tax_total_view" class="form-control form-control-lg form-control-solid" placeholder="Rupiah" value="{{ old('tax_total_view', number_format($tax_total, 2) ?? '') }}" autocomplete="off" readonly/>
                                    <input type="hidden" name="tax_total" id="tax_total" class="form-control form-control-lg form-control-solid" placeholder="Rupiah" value="{{ old('tax_total', $tax_total ?? '') }}" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-bold fs-6">{{ __('Bunga Diterima') }}</label>
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="interest_received_total_view" id="interest_received_total_view" class="form-control form-control-lg form-control-solid" placeholder="Rupiah" value="{{ old('interest_received_total_view', number_format($interest_received_total, 2) ?? '') }}" autocomplete="off" readonly/>
                                    <input type="hidden" name="interest_received_total" id="interest_received_total" class="form-control form-control-lg form-control-solid" placeholder="Rupiah" value="{{ old('interest_received_total', $interest_received_total ?? '') }}" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row mb-6">
                                <label class="col-lg-4 col-form-label fw-bold fs-6">{{ __('Biaya Administrasi') }}</label>
                                <div class="col-lg-8 fv-row">
                                    <input type="text" name="deposito_account_amount_adm_view" id="deposito_account_amount_adm_view" class="form-control form-control-lg form-control-solid" placeholder="Rupiah" value="{{ old('deposito_account_amount_adm_view', $sessiondata['deposito_account_amount_adm'] ?? '') }}" autocomplete="off"/>
                                    <input type="hidden" name="deposito_account_amount_adm" id="deposito_account_amount_adm" class="form-control form-control-lg form-control-solid" placeholder="Rupiah" value="{{ old('deposito_account_amount_adm', $sessiondata['deposito_account_amount_adm'] ?? '') }}" autocomplete="off" readonly/>
                                </div>
                            </div>
                            <div class="row mb-6">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    ...
                    <button type="submit" class="btn btn-primary" id="kt_deposito_account_closing_add_submit">
