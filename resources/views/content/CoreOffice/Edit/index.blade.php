            ...
            @method('PUT')
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8 fv-row">
                            <input type="text" name="incentive_view" id="incentive_view" class="form-control form-control-lg form-control-solid" placeholder="%" value="{{ old('incentive_view', $office->incentive ?? '') }}" autocomplete="off"/>
                            <input type="hidden" name="incentive" id="incentive" class="form-control form-control-lg form-control-solid" placeholder="%" value="{{ old('incentive',$office->incentive ?? '') }}" autocomplete="off" />
                        </div>
                    </div>
                    <div class="row mb-6">
