...
<x-base-layout>
    <div class="card">
        ...
        <form id="kt_filter_journal_memorial_form" class="form" method="POST" action="{{ route('ppob-journal.filter') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
            <div id="kt_card_collapsible" class="collapse">
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <a href="{{ route('ppob-journal.reset-filter') }}" class="btn btn-danger me-2" id="kt_filter_cancel">
                        {{__('Batal')}}
                    </a>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Daftar Jurnal PPOB</h3>
        </div>
        <div class="card-body pt-6">
