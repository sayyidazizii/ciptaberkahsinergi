    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0">
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{ __('Laporan Nominatif Tabungan Anggota') }}</h3>
            </div>
        </div>

        <div id="kt_nominative_savings_view">
            <form id="kt_nominative_savings_view_form" class="form" method="POST" action="{{ route('nominative-savings-report.viewport') }}" enctype="multipart/form-data">
            @csrf
            @method('POST')
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-4 fv-row">
                            ...
                            <select name="kelompok" id="kelompok" aria-label="{{ __('Kelompok') }}" data-control="select2" data-placeholder="{{ __('Pilih kelompok..') }}" data-allow-clear="true" class="form-select form-select-solid form-select-lg">
                                ...
                                @foreach($kelompoklaporansimpanan as $key => $value)
                ...
                <div class="card-footer d-flex justify-content-end py-6 px-9">
                    <button type="submit" class="btn btn-primary me-2" id="kt_nominative_savings_submit" id="view" name="view" value="excel">
                        <i class="bi bi-file-earmark-excel"></i> {{__('Export Excel')}}
                    </button>
                    <button type="submit" class="btn btn-primary" id="kt_nominative_savings_submit" id="view" name="view" value="pdf">
