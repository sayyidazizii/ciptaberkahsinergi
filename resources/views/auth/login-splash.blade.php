            ...
            <form method="POST" action="{{ theme()->getPageUrl('login') }}" class="form w-100" novalidate="novalidate"
                ...
                <div class="container">
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <input class="form-control form-control-lg form-control-solid" type="username"
                            placeholder="Masukan Username ... " name="username" autocomplete="off"
                    ...
                    <div class="fv-row mb-10">
                        <div class="d-flex flex-stack mb-2">
                            ...
                            @if (Route::has('password.request'))
                                <a href="{{ theme()->getPageUrl('password.request') }}"
                        ...
                        <input class="form-control form-control-lg form-control-solid" type="password" name="password"
                            placeholder="Masukan Password ... " autocomplete="off" value="{{ old('password') }}"
                            required />
                    </div>
