...
use App\Http\Controllers\AcctCreditsPaymentInsentiveController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('nominative-savings-pickup')->name('nomv-sv-pickup.')->group(function () {
        ...
        Route::delete('/delete', [AcctNominativeSavingsPickupController::class, 'destroy'])->name('delete');
    ...
    Route::prefix('deposito-account-insentif')->controller(AcctDepositoAccountInsentiveController::class)->name('dps-account-insentif.')->group(function () {
        Route::get('/',  'report')->name('report');
        Route::get('/ao', 'getOffice')->name('get-ao');
        Route::get('/account',  'account')->name('account');
        Route::post('/report/viewport',  'reportViewport')->name('p-viewport');
